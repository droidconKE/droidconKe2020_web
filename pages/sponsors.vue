<template>
  <div class="w-full mt-15 md:mt-14 mb-0">
        ...
        <div class="items-start flex flex-wrap mb-0">
          <div class="w-full md:w-7/12 ml-auto px-2 md:px-8 mt-4 md:mt-0">
            <div class="text-center md:text-left">
              <h3 class="title-px-36 yellow mt-6 md:mt-0">
                sponsor Droidconke
              </h3>
    ...
    <section class="w-full container mx-auto md:px-32 sm:px-10">
      <div class="flex flex-wrap md:pt-16">
        <div class="w-full text-center mb-2 md:mb-0 mt-4 md:mt-0 items-center justify-center">
          <h3 class="title-px-36 black pt-10 md:pt-0">
          ...
          <div class="w-full flex flex-wrap md:w-8/12 mt-10 mb-14 md:mb-0 justify-center md:mt-0 px-2 md:px-10">
            <div class="w-full flex justify-center grid grid-cols-3 ">
              ...
              <div class="justify-center flex items-center px-3 py-5 text-center bg-purple-c">
                <p class="text-px-14-sponsor uppercase yellow">
                  Build relationships
                </p>
              </div>
              <div class="justify-center flex items-center px-3 py-5 text-center bg-purple-c">
    ...
    <section class="w-full bg-green-c md:px-32 sm:px-10">
      <div class="flex flex-wrap md:pt-16">
        <div class="w-full text-center mb-2 md:mb-0 mt-4 md:mt-0 items-center justify-center">
          <h3 class="title-px-36 black pt-8 md:pt-0">
      ...
      <div class="mx-auto container px-4 md:py-10">
        <div class="items-center flex flex-wrap mb-0">
          <div class="w-full px-2 md:px-8 mt-4 mb-14 lg:mb-0 md:mt-0">
