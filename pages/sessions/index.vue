  ...
  <section class="w-full mt-14 mb-12">
    ...
    <div class="w-full flex flex-wrap md:px-32 sm:px-10 mt-2 md:mt-4">
      <div v-if="!$fetchState.pending" class="w-full container mx-auto flex flex-wrap px-4 md:px-12 py-4">
        <div class="flex flex-row lg:flex-col w-full lg:w-1/12 h-auto lg:h-64 bor border-r-0 lg:border-r border-green-200 space-y-0 lg:space-y-6 space-x-6 lg:space-x-0 items-center lg:items-start justify-center lg:justify-start pb-4 lg:pb-0 sticky nav-bg nav-side">
